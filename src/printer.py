...
class LoopPrinter(object):
    ...
    def loop_print(self,
                   ...
                   *,  # Signals keyword-only arguments
                   ...
                   pre_message=None,  # A message just before the print
        ...
        :param str | None pre_message: If None does nothing. If a str - print this message just before the main print.
        ...
        if do_print:
            ...
            final_string = self.indentation + time_message + (" -> " if arrow_needed else "")
            final_string += main_stamp
            pre_message_length = len(final_string) + 2
            final_string += ((": " + message) if message else "")
